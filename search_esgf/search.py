...
def search_esgf(
    experiment: str,
    frequency: Literal["hr", "3hr", "6hr", "subdaily", "day"],
    variables: list[str],
    project: str = "CMIP6",
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            import search_esgf.search_esgf
    ...
    Args:
        ...
        extended_mip_tables: Optional. If you want to use extended MIP tables.
            These tables are probably not relevant for most moisture trackign usecases 
            and can make the search slower. Defaults to False.
...
def _get_mip_tables(
    freq: Literal["hr", "3hr", "6hr", "subdaily", "day"],
    extended: bool = False,
) -> tuple[str, ...]:
    """Return the MIP tables that fit a certain desired data frequency.

    Args:
        freq: Desired frequency. 'hr', '3hr', '6hr', 'subdaily' or 'day'.
        extended (optional): If you want to use extended MIP tables.
            These tables are probably not relevant for most moisture tracking usecases
            and can make the search slower. Defaults to False.
    ...
    mip_tables["subdaily"] = mip_tables["hr"] + mip_tables["3hr"] + mip_tables["6hr"]
